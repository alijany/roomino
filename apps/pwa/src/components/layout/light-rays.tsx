...
// WebGL light-rays background from React Bits (reactbits.dev/backgrounds/light-rays),
// adapted to TypeScript. Requires the `ogl` dependency.
...
// Minimal structural type for the bits of the ogl Renderer we access via refs
// (the `ogl` package ships no TypeScript types).
